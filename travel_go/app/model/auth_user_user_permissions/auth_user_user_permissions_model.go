...
// arModel is a active record design model for table auth_user_user_permissions operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of auth_user_user_permissions.
	Table = "auth_user_user_permissions"
	// Model is the model object of auth_user_user_permissions.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table auth_user_user_permissions.
	Columns = struct {
		Id            string //   
        UserId        string //   
        PermissionId  string //
