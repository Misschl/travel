...
// arModel is a active record design model for table auth_user_groups operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of auth_user_groups.
	Table = "auth_user_groups"
	// Model is the model object of auth_user_groups.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table auth_user_groups.
	Columns = struct {
		Id       string //   
        UserId   string //   
        GroupId  string //
