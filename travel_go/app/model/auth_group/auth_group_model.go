...
// arModel is a active record design model for table auth_group operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of auth_group.
	Table = "auth_group"
	// Model is the model object of auth_group.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table auth_group.
	Columns = struct {
		Id    string //   
        Name  string //
	}{
