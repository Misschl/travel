...
// arModel is a active record design model for table django_admin_log operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of django_admin_log.
	Table = "django_admin_log"
	// Model is the model object of django_admin_log.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table django_admin_log.
	Columns = struct {
		Id             string //   
        ActionTime     string //   
        ObjectId       string //   
