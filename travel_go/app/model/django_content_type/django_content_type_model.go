...
// arModel is a active record design model for table django_content_type operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of django_content_type.
	Table = "django_content_type"
	// Model is the model object of django_content_type.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table django_content_type.
	Columns = struct {
		Id        string //   
        AppLabel  string //   
        Model     string //
