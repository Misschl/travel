...
// arModel is a active record design model for table tbl_user operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tbl_user.
	Table = "tbl_user"
	// Model is the model object of tbl_user.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tbl_user.
	Columns = struct {
		Id             string //   
        Email          string //   
        Password       string //   
