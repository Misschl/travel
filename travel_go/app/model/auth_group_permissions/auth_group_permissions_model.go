...
package auth_group_permissions
...
// arModel is a active record design model for table auth_group_permissions operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of auth_group_permissions.
	Table = "auth_group_permissions"
	// Model is the model object of auth_group_permissions.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table auth_group_permissions.
	Columns = struct {
		Id            string //   
        GroupId       string //   
        PermissionId  string //
