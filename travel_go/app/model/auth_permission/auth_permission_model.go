...
// arModel is a active record design model for table auth_permission operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of auth_permission.
	Table = "auth_permission"
	// Model is the model object of auth_permission.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table auth_permission.
	Columns = struct {
		Id             string //   
        Name           string //   
