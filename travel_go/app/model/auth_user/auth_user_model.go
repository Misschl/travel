...
// arModel is a active record design model for table auth_user operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of auth_user.
	Table = "auth_user"
	// Model is the model object of auth_user.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table auth_user.
	Columns = struct {
		Id           string //   
        Password     string //   
        LastLogin    string //   
