...
// arModel is a active record design model for table django_migrations operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of django_migrations.
	Table = "django_migrations"
	// Model is the model object of django_migrations.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table django_migrations.
	Columns = struct {
		Id       string //   
        App      string //   
        Name     string //   
