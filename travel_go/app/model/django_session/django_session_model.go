...
// arModel is a active record design model for table django_session operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of django_session.
	Table = "django_session"
	// Model is the model object of django_session.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table django_session.
	Columns = struct {
		SessionKey   string //   
        SessionData  string //   
        ExpireDate   string //
